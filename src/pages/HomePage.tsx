        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg border p-6">
              ...
              <h3 className="font-semibold text-lg mb-2 text-center">Multi-Regulation Compliance</h3>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg border p-6">
              ...
              <h3 className="font-semibold text-lg mb-2 text-center">Self-Service Portal</h3>
              <p className="text-sm text-muted-foreground mb-4 text-center">
                Empowers all stakeholders to understand duties and exercise rights independently
              </p>
              <ul className="text-xs text-muted-foreground space-y-1">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg border p-6">
              ...
              <h3 className="font-semibold text-lg mb-2 text-center">Automated Workflows</h3>
              <p className="text-sm text-muted-foreground mb-4 text-center">
                Streamline compliance processes with intelligent automation and alerts
              </p>
              <ul className="text-xs text-muted-foreground space-y-1">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg border p-6">
              ...
              <h3 className="font-semibold text-lg mb-2 text-center">Analytics & Insights</h3>
              <p className="text-sm text-muted-foreground mb-4 text-center">
                Comprehensive analytics and reporting for privacy program performance
              </p>
              <ul className="text-xs text-muted-foreground space-y-1">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg border p-6">
              ...
              <h3 className="font-semibold text-lg mb-2 text-center">Stakeholder Management</h3>
              <p className="text-sm text-muted-foreground mb-4 text-center">
                Complete access control and permission management for all user types
              </p>
              <ul className="text-xs text-muted-foreground space-y-1">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg border p-6">
              ...
              <h3 className="font-semibold text-lg mb-2 text-center">Vendor Oversight</h3>
              <p className="text-sm text-muted-foreground mb-4 text-center">
                Comprehensive third-party vendor privacy assessment and monitoring
              </p>
              <ul className="text-xs text-muted-foreground space-y-1">
